...
class ColorManager {
  ...
  static const Color white2 = Color(0xffF4F5F7);
  ...
  static const Color blackWith57Opacity = Color.fromRGBO(0, 0, 0, 0.57);
  ...
  static Color grey5 = const Color.fromARGB(0x76, 0x76, 0x80, 12);
